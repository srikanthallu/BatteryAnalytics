...
def main(infile, n_split, features, window, horizon, n_filters, kernel_size, hidden_dim, transfer, n_epochs, training_filter, model_id):
	...
	train_model(samples, n_split, features, target, window, horizon, n_filters, kernel_size, hidden_dim, transfer, n_epochs, training_filter, model_id)
...
if __name__ == "__main__":
	...
	parser.add_argument(
		...
		type=int,
		required=True,
		help="size of each kernel per convolutional layer"
	)
	...
	parser.add_argument(
		...
		type=int,
		required=True,
		help="CNN hidden dimension size(s)"
	)
