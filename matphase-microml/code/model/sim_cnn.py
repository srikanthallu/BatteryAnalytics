...
class SimCNN(nn.Module):
    def __init__(self, n_channels, n_classes, loc):
        ...
        self.conv1 = nn.Conv2d(n_channels, 32, 5, padding=2)
        self.conv2 = nn.Conv2d(32, 32, 5, padding =2) #kernel=3
        self.conv3 = nn.Conv2d(32, 16, 5, padding=2) #remove
        self.conv4 = nn.Conv2d(16, 16, 5, padding =2) #remove
        self.conv5 = nn.Conv2d(16, 8, 3, padding=1) #remove
    ...
    def forward(self, x, embed):
        ...
        #print('Before pooling 1st layer:', x.shape)
        x = self.pool(x)
...
def main():
    ...
    train_dataset=M2Dataset(dir_img,dir_label,dir_idk, dir_embed, dir_embed, 8)
    ...
    model = SimCNN(n_channels=4, n_classes=3, loc=8)
